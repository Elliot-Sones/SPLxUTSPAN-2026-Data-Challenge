"""
Fast noise floor test: Reduced tree counts for quick results.

Tests with 3 configurations:
1. Baseline: 200 trees (regularized)
2. Medium: 500 trees (less regularization)
3. Heavy: 1000 trees (minimal regularization)
"""
...
def test_noise_floor():
    """Test with progressively more overfitting models (fast version)."""
    ...
    for config in configs:
        ...
        results.append({
            ...
            'train_mse_angle': train_mses[0],
            'train_mse_depth': train_mses[1],
            'train_mse_lr': train_mses[2],
        })
