...
- run_tag: `rs_nested_fb_hybrid_pilot_20260214`
- command: `scripts/research_standard_nested_oof_ensemble.py --scale 1 --seed 20260214 --best-lb 0.006596 --top-k-submissions 3 --feature-bank hybrid_advanced --models all --run-tag rs_nested_fb_hybrid_pilot_20260214`
- seed: `20260214`
- scale: `1`
- feature_bank: `hybrid_advanced`
- models_arg: `all`
...
- file: `submission/submission_2381.csv`
  - submission_num: `2381`
  - combo_id: `52`
...
- file: `submission/submission_2382.csv`
  - submission_num: `2382`
  - combo_id: `19`
...
- file: `submission/submission_2383.csv`
  - submission_num: `2383`
  - combo_id: `33`
...
- outer_metrics_csv: `output/research_standard_outer_metrics_rs_nested_fb_hybrid_pilot_20260214.csv`
- tuning_csv: `output/research_standard_tuning_rs_nested_fb_hybrid_pilot_20260214.csv`
- target_weight_csv: `output/research_standard_target_weight_search_rs_nested_fb_hybrid_pilot_20260214.csv`
- ensemble_candidates_csv: `output/research_standard_ensemble_candidates_rs_nested_fb_hybrid_pilot_20260214.csv`
- selected_csv: `output/research_standard_selected_rs_nested_fb_hybrid_pilot_20260214.csv`
- run_json: `output/research_standard_run_rs_nested_fb_hybrid_pilot_20260214.json`
- details_md: `output/research_standard_submission_details_rs_nested_fb_hybrid_pilot_20260214.md`
- elapsed_seconds: `14.945569`
