...
<Research>
  After doing research please add the research and findings to the research folder. Before doing any tests you should first check what are the findings and how we can build off of what we already know so we dont just rediscover something we already know
</research>
